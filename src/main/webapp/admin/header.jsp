					...
					<div class="container header-inner">
					  ...
					  <nav class="header-nav">
						<ul class="menu-area-main">
						  ...
						  <li><a href="manageDepartments.jsp">Departments</a></li>
						  <li><a href="manageCourses.jsp">Courses</a></li>
						  <li><a href="manageBatches.jsp">Batches</a></li>
						  <li><a href="manageStaffs.jsp">Manage staff</a></li>
