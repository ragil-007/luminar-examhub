...
<html lang="en">
   <head>
      ...
      <script src="js/loadStaff.js"></script>
      <script src="js/loadStudents.js"></script>
					...
					<div class="container header-inner">
					  ...
					  <nav class="header-nav">
						<ul class="menu-area-main">
						  <li class="active"><a href="academicHome.jsp">Home</a></li>
						  <li><a href="manageStudents.jsp">Students</a></li>
						  <li><a href="manageExamModes.jsp">Exam modes</a></li>
						  <li><a href="manageExams.jsp">Exam allocation</a></li>
						  <li><a href="manageExamResult.jsp">Exam result</a></li>
