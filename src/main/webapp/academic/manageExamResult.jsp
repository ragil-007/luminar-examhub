			  ...
			  <div class="container">
				<div class="data-card">
					...
					<div class="table-toolbar">
					  ...
					  <p class="toolbar-desc">Add and manage exam results</p>
					  ...
					  <div class="toolbar-right">
						<a href="addExamResult.jsp" class="btn-primary">
						  + New score
						</a>
					  </div>
					</div>
					  ...
					  <tr>
						...
						<td>
						  <div class="table-actions">
							<a href="editExamResult.jsp?resultId=<%= examResult.getExamScoreId() %>"><button class="btn-edit">Edit</button></a>
							<button class="btn-delete" onclick="confirmExamResultDelete(<%= examResult.getExamScoreId() %>)">Delete</button>
						  </div>
						</td>
					  </tr>
					  	<%
